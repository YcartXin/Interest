...
- Defensive Efficiency - out rate after a ball is in play
- Earned Run Average - average earned runs allowed per none innings
- Wins
...
We can understand this data better by understanding the distribution of some of the variables as well as the summary statistics. For instance, we can understand the competitiveness of MLB by seeing the distribution of wins per season, whether the teams differ significantly by wins can help us analyze whether there is a significant disparity in the strengths of different teams. @fig-wins shows the distribution of the wins data of each team among 162 games in a season between 2000 to 2010.
...
```
We can also get a sense of the average strength of the a MLB team in terms of the predictors by looking at their summary data. This is shown in @tbl-summary.
